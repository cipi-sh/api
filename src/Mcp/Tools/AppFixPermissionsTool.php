...
#[Description('Restore an app home to the permission model Cipi created it with (cipi app fix-permissions): ownership, 750 home, 700 .ssh, 640 shared/.env, log ACLs, storage 775. Dispatches an async job; poll JobShow. Requires Cipi CLI ≥ 5.2.1.')]
class AppFixPermissionsTool extends Tool
{
