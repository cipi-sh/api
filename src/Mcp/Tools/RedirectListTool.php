...
#[Description('List the whole-app redirect and path redirects of an app (cipi redirect list). Requires Cipi CLI ≥ 5.4.1.')]
#[IsReadOnly]
class RedirectListTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        try {
            return Response::text(json_encode($this->routes->redirects($name), JSON_PRETTY_PRINT));
